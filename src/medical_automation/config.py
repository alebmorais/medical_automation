...
class Config:
    ...
    SNIPPET_ADMIN_HEADER: str = os.getenv("SNIPPET_ADMIN_HEADER", "X-Admin-Token")  # FIX: add header
    ...
    @classmethod
    def validate(cls):
        # Warn (not hard fail) if SQL files are missing to avoid blocking dev runs
        missing = []
